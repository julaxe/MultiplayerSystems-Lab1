...
static public class AssignmentPart1
{
    ...
    {
        StreamWriter sw = new StreamWriter(Application.dataPath + Path.DirectorySeparatorChar + "OurSaveFile.txt");
    ...
    static public void LoadPartyButtonPressed()
    {
        ...
        string line = "";
        StreamReader sr = new StreamReader(Application.dataPath + Path.DirectorySeparatorChar + "OurSaveFile.txt");
